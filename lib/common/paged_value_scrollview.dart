...
typedef PagedValueScrollViewIndexedWidgetBuilder<T> =
    Widget Function(BuildContext context, List<T> values, int index);

/// Signature for the item builder that creates the children of the
/// [PagedValueListView] and [PagedValueGridView].
typedef PagedValueScrollViewLoadMoreErrorBuilder =
    Widget Function(BuildContext context, ErrorModel error);
...
class PagedValueGridView<K, V> extends StatefulWidget {
  ...
  final Widget Function(BuildContext, ErrorModel) errorBuilder;
